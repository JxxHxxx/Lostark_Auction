...
# 추출한 dataset 을 넣어주세요.
dataset_1 = pd.read_csv('C:/Users/JH/Desktop/price/dataset_20210723.csv',index_col=0)
...
dataset_1.to_csv('C:/Users/JH/Desktop/price/dataset_merge.csv', mode='a', encoding= 'utf-8-sig')
